...
export const AggregatedIngredientSchema = {
    properties: {
        name: {
            type: 'string',
            title: 'Name'
    ...
    type: 'object',
    required: ['name', 'unit', 'total_quantity', 'is_checked', 'sources'],
    title: 'AggregatedIngredient',
    description: 'An ingredient aggregated across all recipes in a shopping list.'
} as const;
...
export const HouseholdsPublicSchema = {
    properties: {
        data: {
            items: {
                '$ref': '#/components/schemas/HouseholdPublic'
            },
            type: 'array',
            title: 'Data'
        },
...
export const RecipeIngredientPublicSchema = {
    ...
    type: 'object',
    required: ['name', 'quantity', 'unit', 'id', 'recipe_id'],
...
export const ShoppingListRecipeCreateSchema = {
    properties: {
        num_people: {
            type: 'integer',
            minimum: 1,
    ...
    type: 'object',
    required: ['num_people', 'recipe_id'],
    title: 'ShoppingListRecipeCreate'
} as const;
...
export const ShoppingListRecipePublicSchema = {
    properties: {
        ...
        recipe_base_servings: {
            type: 'integer',
            title: 'Recipe Base Servings'
        }
    },
    type: 'object',
    required: ['num_people', 'id', 'recipe_id', 'recipe_title', 'recipe_base_servings'],
...
export const ShoppingListSummarySchema = {
    properties: {
        name: {
            type: 'string',
            maxLength: 255,
...
export const ShoppingListsSummarySchema = {
    properties: {
        data: {
            items: {

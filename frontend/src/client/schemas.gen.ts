...
export const AisleLayoutSchema = {
    type: 'string',
    enum: ['supermarket', 'market'],
    title: 'AisleLayout',
    description: `Which walking order to print a list in.
...
export const CartHandoffSchema = {
    ...
    type: 'object',
    required: ['store_slug', 'transport'],
    title: 'CartHandoff',
    description: `How the user gets from our list into the store's basket.
...
export const ExportedListSchema = {
    ...
    type: 'object',
    required: ['store_slug', 'store_name', 'format'],
    title: 'ExportedList',
...
export const ListExportFormatSchema = {
    ...
    description: 'How an exported list renders its output.'
} as const;
...
export const RefreshResultSchema = {
    properties: {
        ...
        skipped: {
            items: {
                '$ref': '#/components/schemas/RefreshSkip'
            },
            type: 'array',
            title: 'Skipped'
        },
    ...
    type: 'object',
    required: ['store_id', 'store_name', 'provider_slug'],
    title: 'RefreshResult',
    description: 'What one refresh actually managed to do.'
} as const;

export const RefreshSkipSchema = {
    properties: {
        ingredient_name: {
            type: 'string',
            title: 'Ingredient Name'
...
export const StoreListRequestSchema = {
    properties: {
        shopping_list_id: {
            type: 'string',
            format: 'uuid',
    ...
    title: 'StoreListRequest',
    description: "Ask a store to take delivery of one of the user's lists."
} as const;
